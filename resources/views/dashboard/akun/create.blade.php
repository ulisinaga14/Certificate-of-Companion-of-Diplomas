...
<div class="col-lg-8">
<form method="post" action="/dashboard/akun">
    @csrf
<div class="row">
  <div class="col">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="password" id="password" name="password"  class="form-control @error('password') is-invalid @enderror" required value="{{ old('password') }}"/>
            @error('password')
            <div  class="invalid-feedback">
              {{ $message }}
            </div>
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="sandi" id="sandi" name="sandi"  class="form-control @error('sandi') is-invalid @enderror" required value="{{ old('sandi') }}"/>
            @error('sandi')
            <div  class="invalid-feedback">
              {{ $message }}
            </div>
