...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create Data Informasi Tambahan</h1>
    
</div>
<form method="post" action="/dashboard/info" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="alert alert-primary">
                <strong>Isi Informasi Tambahan Sesuai Kategori Yang Diikuti</i></strong>
            </div>
            <div class="row">
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-7 mb-2">
                        ...
                        <small><i>Diisi oleh admin</i></small>
                        @error('ket_idn')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                       ...
                       <small><i>Upload Sertifikat/Bukti Mengikuti Kegiatan (Disarankan!)</i></small>
                        @error('image')
                        <div  class="invalid-feedback">
                          {{ $message }}
                        </div>
