...
<form method="post" action="/dashboard/info/{{ $info->topik_idn }} " enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                <label>Place :</label>
                <input type="text" class="form-control @error('place') is-invalid @enderror" id="place" name="place" required autofocus value="{{ old('place', $info->tempat) }}">
                @error('place')
                <div class="invalid-feedback">
                {{ $message }}
                </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('institution') is-invalid @enderror" id="institution" name="institution" required autofocus value="{{ old('institution', $info->penyelenggara) }}">
                @error('institution')
                <div class="invalid-feedback">
                {{ $message }}
                </div>
    ...
    <div class="row">
                <div class="col-sm-4 mt-1">
                    <div class="form-group">
                        ...
                        @if ($info->image)
                        <img src="{{asset('sertifikat/')}}/{{$i->image}}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
                    ...
                    <div class="alert alert-primary">
                        <strong>Form Capaian Pembelajaran</i></strong>
                    </div>
                    <div class="row">
                    <div class="col-sm-7" >
                        <label for="ket_idn" class="form-label"><b>*Capaian Pembelajaran</b> </label>
                        <textarea type="text" class="form-control @error('ket_idn') is-invalid @enderror" name="ket_idn" autofocus >{{ old('ket_idn', $info->ket_idn) }}
                        </textarea>
                        <small><i>Disii oleh admin</i> </small>
                        @error('ket_idn')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-sm-7" >
                        <label for="ket_ing" class="form-label"><b>*Achievment Learning</b> </label>
                        <textarea type="text" class="form-control @error('ket_ing') is-invalid @enderror" name="ket_ing" autofocus >{{ old('ket_ing', $info->ket_ing) }}
                        </textarea>
                        <small><i>Disii oleh penerjemah</i> </small>
                        @error('ket_ing')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
