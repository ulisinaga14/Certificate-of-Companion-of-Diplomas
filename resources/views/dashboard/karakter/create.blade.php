...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create Data Pendidikan Karakter</h1>
    
</div>
<form method="post" action="/dashboard/karakter" class="mb-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                       ...
                       <small><i>Upload Bukti Ikut Serta Pendidikan Karakter</i></small>
                        @error('image')
                        <div  class="invalid-feedback">
                          {{ $message }}
                        </div>
