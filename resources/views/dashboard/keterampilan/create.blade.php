...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create Data Keterampilan/Keahlian</h1>
    
</div>
<form method="post" action="/dashboard/keterampilan" class="mb-5" enctype="multipart/form-data">
            @csrf
