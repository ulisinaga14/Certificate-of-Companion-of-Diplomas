...
<div class="row justify-content-center mb-3">
  <div class="col-md-6">
    <form action="/blog">
      @if (request('category')) {{-- jika di dalam request ada kategory --}}
          <input type="hidden" name="category" value="{{ request('category') }}">  
      @endif

      @if (request('author')) {{-- jika di dalam request ada author --}}
...
@if ($posts->count()) 
    <div class="card mb-3">
      ...
      <div style="max-height :350 px; overflow:hidden;">
...
{{-- method untuk menampilkan link pagination --}}
{{ $posts->links() }}
</div>
@endsection
